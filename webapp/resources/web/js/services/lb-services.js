...
/**
 * @ngdoc object
 * @name lbServices.Sample
 * @header lbServices.Sample
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Sample` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Sample#create
         * @methodOf lbServices.Sample
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
        ...
        /**
         * @ngdoc method
         * @name lbServices.Sample#createMany
         * @methodOf lbServices.Sample
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/samples/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Sample#findById
         * @methodOf lbServices.Sample
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/samples/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Sample#find
         * @methodOf lbServices.Sample
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Sample#findOne
         * @methodOf lbServices.Sample
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/samples/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Sample#updateAll
         * @methodOf lbServices.Sample
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/samples/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Sample#deleteById
         * @methodOf lbServices.Sample
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/samples/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Sample#prototype$updateAttributes
         * @methodOf lbServices.Sample
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Sample#createChangeStream
         * @methodOf lbServices.Sample
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/samples/change-stream",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Sample#status
         * @methodOf lbServices.Sample
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Sample#updateOrCreate
         * @methodOf lbServices.Sample
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Sample#destroyById
         * @methodOf lbServices.Sample
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Sample#removeById
         * @methodOf lbServices.Sample
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Sample#modelName
    * @propertyOf lbServices.Sample
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Sample`.
    */
